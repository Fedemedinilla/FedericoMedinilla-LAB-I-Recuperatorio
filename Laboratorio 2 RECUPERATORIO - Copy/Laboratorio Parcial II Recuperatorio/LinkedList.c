...
int ll_remove(LinkedList* this,int index)
{
    ...
    if(this!=NULL && index>-1 && index<ll_len(this))
    {
        ...
        else
        {
            ...
            prevNode->pNextNode=pNodoBorrar->pNextNode;
        }
        this->size--;
        free(pNodoBorrar);
        returnAux=0;
    ...
    if(this!=NULL && (*pFunc)!=NULL && order>=0 && order<=1)
    {
        ...
        for(int i=0;i<tam-1;i++)
        {
            for(int x=i+1;x<tam;x++)
            {
                aux1=ll_get(this,i);
                aux2=ll_get(this,x);
                if(pFunc(ll_get(this,i) , ll_get(this,x))<0 && order==0)
                {
                    ll_set(this,i,aux2);
                    ll_set(this,x,aux1);
                }
                ...
                {
                    if(pFunc(ll_get(this, i) , ll_get(this, x))>0 && order==1)
                    {
                        ll_set(this,i,aux2);
                        ll_set(this,x,aux1);
                    }
